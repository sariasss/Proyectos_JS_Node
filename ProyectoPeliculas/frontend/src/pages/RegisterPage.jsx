    ...
    return (
        <div className="flex items-center justify-center bg-gray-100">
            <div className="max-w-md w-full space-y-8">
                <h2 className="mt-2 text-center text-4xl font-bold text-gray-900">Registro</h2>
                ...
                <NavLink to="/login" className="hover:text-amber-400">¿Ya tienes cuenta? Inicia sesión</NavLink>
            </div>
        </div>
    );
};
